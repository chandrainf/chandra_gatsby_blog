...
const pageText = {
  paraOne: `Hello !! My name is Chandra Pratama Putra. I'm a full stack web developer who is
    ...
    is what Chandra loves to do. Check my blog which I update every week for some Javascript and some
      ...
      <Row gutter={[20, 20]}>
        <Col xs={24} sm={24} md={12} lg={8}>
          <AboutTile
            ...
            textH3="Payakumbuh, West Sumatera, Indonesia"
          />
        </Col>
        <Col xs={24} sm={24} md={12} lg={8}>
          <AboutTile
        ...
        <Col xs={24} sm={24} md={12} lg={8}>
          <AboutTile
            ...
            textH4="Pursued Amd in"
            textH3="Informatic Management"
            height={60}
            width={60}
          />
        </Col>
