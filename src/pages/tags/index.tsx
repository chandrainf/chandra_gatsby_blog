...
// TODO: Need to configure type more definitely.
...
const Tags = ({ data }: any) => {
  ...
  const rawTags = data.allMarkdownRemark.edges
    .map((edge: any) => edge.node.frontmatter.tags)
    .reduce((prev: any, curr: any) => prev.concat(curr));
  rawTags
    .filter((tag: any, index: any) => index === rawTags.indexOf(tag))
    .sort(); // Remove duplicates and sort values
  // const tagPage = Config.pages.tag;
  const tagData: any = Config.tags;
  return (
